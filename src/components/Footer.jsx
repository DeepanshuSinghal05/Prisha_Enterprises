...
const Footer = () => {
  ...
  const businessEmail = import.meta.env.VITE_BUSINESS_EMAIL || 'info@prishaenterprises.com';
  const businessPhone = import.meta.env.VITE_BUSINESS_PHONE || '+91 99999 99999';
  const businessAddress = import.meta.env.VITE_BUSINESS_ADDRESS || '123 Business Street, City, State - 000000';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center space-x-3">
              ...
              />
              <span className="text-xl font-bold">Prisha Enterprises</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400 text-sm">{businessAddress}</span>
              </li>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-400 text-sm flex items-center">
              Made with <FaHeart className="h-4 w-4 text-red-500 mx-1" /> in India
            </p>
          </div>
        </div>
      </div>
